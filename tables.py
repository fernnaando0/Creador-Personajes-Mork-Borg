...
armors = [
    {"name": "Sin armadura", "tier": 0, "dr_dice": None},
    {"name": "Sin armadura", "tier": 0, "dr_dice": None},
    {"name": "Pelaje/Cuero", "tier": 1, "dr_dice": 2},
    {"name": "Pelaje/Cuero", "tier": 1, "dr_dice": 2},
    {"name": "Acero/Malla", "tier": 2, "dr_dice": 4},
    {"name": "Acero/Malla", "tier": 2, "dr_dice": 4},
]

# Armas (Weapons) - Tabla inicial básica
weapons = [
    {"name": "Fémur", "damage_dice": 2},
    {"name": "Bastón de lucha", "damage_dice": 4},
    {"name": "Espada corta", "damage_dice": 4},
    {"name": "Cuchillo", "damage_dice": 4},
    {"name": "Martillo de guerra", "damage_dice": 6},
    {"name": "Espada", "damage_dice": 6},
    {"name": "Arco (Presencia y 10 flechas)", "damage_dice": 6},
    {"name": "Maza", "damage_dice": 8},
    {"name": "Ballesta (Presencia y 10 proyectiles)", "damage_dice": 8},
    {"name": "Mandoble", "damage_dice": 8},
]
...
objetos_lista1 = [
    "Cuerda de 10 metros",
    "Presencia + 4 antorchas",
    "Linterna con aceite para Presencia + 6 horas",
    "Barra de magnesio",
    "Unclean Scroll aleatorio",
    "Aguja muy afilada",
    "Un botiquín con presencia +4 usos",
    "Plancha de metal y clavos",
    "Trampa para osos (DR14 para ponerla, D8 daño)",
    "Bomba (D10 daño)",
    "Veneno D4 dosis (D10 daño)",
    "Crucifijo de plata",
]

objetos_lista2 = [
    "1 elixir de la vida D4 dosis (Recuperas HP6 y cura infección)",
    "Scroll sagrado aleatorio",
    "Perro pequeño y vicioso que solo te obedece a ti (D6 + 2 HP, D4 daño)",
    "Perfume de gran calidad (valorado en 25 de plata)",
    "Caja de herramientas con 10 clavos, pinzas, martillo, sierra pequeña y taladro manual",
    "Pesada cadena de 5 metros",
    "Gancho de agarre",
    "Escudo (-1 HP damage o romperlo para parar un ataque)",
    "Palanca (D4 daño)",
    "Grasa animal (Equivale a 5 días de comida)",
    "Tienda de campaña",
]
